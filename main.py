...
# This part is image labels setting start 
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"Images_GUI\Databse.jpg")
        ...
        pho_b1_1 = Button(bg_img,command=self.open_img,text="Database",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
